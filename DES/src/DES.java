public class DES {
        ...
        public static void main(String[] args) {
                ...
                System.out.println("КЛЮЧ                :  " + hex(keys));

                String result = hex(encrypt(test, keys));
                System.out.println("ВВЕДЕННЫЙ ТЕКСТ     :  " + hex(test));
                System.out.println("ЗАШИФРОВАННЫЙ ТЕКСТ :  " + result);

                byte[] encResult = parseBytes(result);
                String decResult = hex(decrypt(encResult,keys));
                System.out.println("РАСШИФРОВАННЫЙ ТЕКСТ:  " + decResult);
